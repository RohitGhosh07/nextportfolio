...
const Skills = () => {
    return (
        <div className="flex items-start justify-end" id="skills">
            <div>
                <div className="relative flex items-end justify-end">
                    ...
                    <div>
                        ...
                        <div className="relative z-10 p-4">
                            ...
                            <div className="flex  items-center rounded-md bg-white  shadow-xl shadow-black/5 ring-1 ring-slate-700/10">
                                <div className="pointer-events-auto w-[30rem] rounded-lg bg-white text-[0.8125rem] leading-5 shadow-xl shadow-black/5 hover:bg-slate-50 ring-1 ring-slate-700/10 flex justify-end">
                                    <div className="aspect-w-4 aspect-h-3 rounded-lg overflow-hidden">
                                        <img
                                            src="https://i.ibb.co/qybyD9k/new-linkedin-banner.png"
                                            alt=""
                        ...
                        <div className="space-y-4">
                            <div className="pointer-events-auto w-[21rem] rounded-lg bg-white p-4 text-[0.8125rem] leading-5 shadow-xl shadow-black/5 hover:bg-slate-50 ring-2 ring-indigo-600">
                                ...
                                <div className="mt-1 text-slate-700">
                                    Hey there! 👋 I'm a digital dreamweaver ✨, weaving the web's magic with HTML/CSS as my canvas, React.js as my wand, Java for the logic spells,
                                    and I sprinkle Bootstrap & Firebase for that fiery touch.
                                    When I'm not coding spells, you'll find me nestled in nature's embrace 🌳.
                                    Ready to conjure digital wonders? Let's connect and make the internet a more enchanting place! 🚀
                                </div>
                                <div className="mt-6 font-medium text-slate-900">
                                    621 users
                                </div>
                            </div>
                            {/* <div className="pointer-events-auto flex-grow rounded-lg text-[0.8125rem] leading-5 shadow-xl shadow-black/5 hover:bg-slate-50 ring-1 ring-slate-700/10 flex justify-end">
                                                <div className="aspect-w-4 aspect-h-3 rounded-lg overflow-hidden flex-grow-0 flex-shrink-0">
                                                    <img
                                                        src="https://i.ibb.co/qybyD9k/new-linkedin-banner.png"
                                                        alt=""
                                                        className="object-cover w-full h-full rounded-lg shadow-lg"
 ...
 */}
                ...
                <div className="flex items-start justify-end ">
                    <div className="animate-pulse relative p-4">
                        <div className="absolute -inset-y-8 left-0 w-px bg-slate-900/15 [mask-image:linear-gradient(to_top,transparent,white_4rem,white_calc(100%-4rem),transparent)]"></div>
                        <div className="absolute -inset-x-8 bottom-0 h-px bg-slate-900/15 [mask-image:linear-gradient(to_left,transparent,white_4rem,white_calc(100%-4rem),transparent)]"></div>
                        <div className="pointer-events-auto w-36 space-y-1 rounded-lg bg-white p-3 text-[0.8125rem] font-medium leading-6 text-slate-700 shadow-xl shadow-black/5 ring-1 ring-slate-700/10">
                            <div className="flex rounded-[10px] p-1 bg-slate-50">
                                <div className="flex h-6 w-6 flex-none items-center justify-center rounded-md bg-white shadow  ring-slate-900/10">
                                ...
                                <div className="ml-3 text-slate-900">LeetCode</div>
                            </div>
                            ...
                            <div className="flex rounded-[10px] p-1">
                                ...
                                <div className="ml-3">HackerRank</div>
                            </div>
                        </div>
                    </div>
                    <div className="relative p-4">
                        ...
                        <div className="pointer-events-auto w-[28.125rem] text-[0.8125rem] leading-5 text-slate-700">
                            ...
                            <div className="mt-4 overflow-hidden rounded-md bg-white py-1 shadow-xl shadow-black/5 ring-1 ring-slate-700/10">
                                ...
                                <div className="px-3 py-2">Javascript</div>
                                <div className="px-3 py-2">C</div>
                                <div className="px-3 py-2">SQL</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div>
                <div className="relative p-4">
                    <div className="pointer-events-auto w-[25.625rem] rounded-lg bg-white text-[0.8125rem] leading-5 text-slate-700 shadow-xl shadow-black/5 ring-1 ring-slate-700/10">
                        <div className="flex items-center px-3.5 py-2.5 text-slate-400">
                            ...
                            <svg className="mr-2.5 h-5 w-5 flex-none stroke-slate-200" version="1.0" xmlns="http://www.w3.org/2000/svg"
                                width="25.000000pt" height="25.000000pt" viewBox="0 0 50.000000 50.000000"
                                preserveAspectRatio="xMidYMid meet">

                                <g transform="translate(0.000000,50.000000) scale(0.100000,-0.100000)"
                                    fill="grey" stroke="none">
                                    <path d="M163 450 c-45 -20 -68 -48 -78 -95 -4 -16 -19 -54 -34 -83 l-26 -54
                                                        28 -20 c20 -15 27 -28 27 -54 0 -41 29 -74 65 -74 18 0 25 -5 25 -20 0 -11 5
                                                        -20 10 -20 6 0 10 14 10 30 0 28 -3 30 -35 30 -39 0 -49 13 -60 83 -3 20 -9
                                                        37 -13 37 -28 1 -30 18 -7 65 14 26 25 56 25 64 0 33 41 82 82 100 23 9 37 20
                                                        32 24 -5 3 -28 -3 -51 -13z"/>
                                    <path d="M300 452 c0 -27 -9 -32 -31 -19 -27 17 -56 -12 -40 -41 12 -22 6 -32
                                                        -21 -32 -13 0 -18 -8 -18 -30 0 -22 5 -30 18 -30 27 0 32 -9 19 -31 -17 -27
                                                        12 -56 41 -40 22 12 32 6 32 -21 0 -13 8 -18 30 -18 22 0 30 5 30 18 0 27 10
                                                        33 32 21 29 -15 54 10 39 39 -12 22 -6 32 21 32 13 0 18 8 18 30 0 22 -5 30
                                                        -18 30 -27 0 -33 10 -21 32 15 29 -10 54 -39 39 -22 -12 -32 -6 -32 21 0 13
                                                        -8 18 -30 18 -22 0 -30 -5 -30 -18z m40 -17 c0 -21 38 -39 54 -26 17 14 29 2
                                                        15 -15 -13 -16 5 -54 26 -54 8 0 15 -4 15 -10 0 -5 -7 -10 -15 -10 -21 0 -39
                                                        -38 -26 -54 14 -17 2 -29 -15 -15 -16 13 -54 -5 -54 -26 0 -8 -4 -15 -10 -15
                                                        -5 0 -10 7 -10 15 0 21 -38 39 -54 26 -17 -14 -29 -2 -15 15 13 16 -5 54 -26
                                                        54 -8 0 -15 5 -15 10 0 6 7 10 15 10 21 0 39 38 26 54 -14 17 -2 29 15 15 16
                                                        -13 54 5 54 26 0 8 5 15 10 15 6 0 10 -7 10 -15z"/>
                                    ...
                                    <path d="M364 155 c-16 -39 -19 -125 -4 -125 6 0 10 21 10 48 0 26 7 60 15 76
                                                        18 34 18 36 4 36 -5 0 -17 -16 -25 -35z"/>
                                </g>
                            </svg>
                        ...
                        <div className="border-t border-slate-400/20 px-3.5 py-3">
                            ...
                            <div className="flex items-center rounded-md p-1.5 bg-indigo-600 text-white">
                                <svg className="mr-2.5 h-5 w-5 flex-none stroke-slate-200" fill="none" height="15" viewBox="0 0 15 15" width="15" xmlns="http://www.w3.org/2000/svg"><path d="m4.5 4.5.40534-.29275c-.12698-.17581-.35282-.24972-.55917-.183-.20636.06673-.34617.25888-.34617.47575zm3 9.5c-3.58985 0-6.5-2.9101-6.5-6.5h-1c0 4.1421 3.35786 7.5 7.5 7.5zm6.5-6.5c0 3.5899-2.9101 6.5-6.5 6.5v1c4.1421 0 7.5-3.3579 7.5-7.5zm-6.5-6.5c3.5899 0 6.5 2.91015 6.5 6.5h1c0-4.14214-3.3579-7.5-7.5-7.5zm0-1c-4.14214 0-7.5 3.35786-7.5 7.5h1c0-3.58985 2.91015-6.5 6.5-6.5zm-2.5 12v-7.5h-1v7.5zm-.90534-7.20725 6.50004 8.99995.8106-.5854-6.49996-9.00005zm5.90534-.79275v6h1v-6z" fill="#FFFFFF" /></svg>
                                Next JS / Website creation
                            </div>
                            <div className="flex items-center rounded-md p-1.5">
                                <svg className="mr-2.5 h-5 w-5 flex-none stroke-slate-200" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 73.29"><defs><style></style></defs><title>tailwind-css</title><path className="cls-1" d="M61.44,0Q36.87,0,30.72,24.43q9.22-12.21,21.5-9.16c4.68,1.16,8,4.53,11.72,8.26,6,6.08,13,13.11,28.22,13.11q24.57,0,30.72-24.43-9.21,12.22-21.5,9.16c-4.68-1.16-8-4.53-11.72-8.26C83.64,7,76.67,0,61.44,0ZM30.72,36.64Q6.15,36.64,0,61.07q9.23-12.21,21.5-9.16c4.68,1.16,8,4.53,11.72,8.27,6,6.07,13,13.11,28.22,13.11q24.57,0,30.72-24.43Q82.95,61.07,70.66,58c-4.68-1.16-8-4.53-11.72-8.26-6-6.08-13-13.12-28.22-13.12Z" fill="#94a3b8" /></svg>
                                Tailwind CSS  / Website design
                            </div>
                        </div>
                        <div className="border-t border-slate-400/20 px-3.5 py-3">
                            <div className="flex items-center rounded-md p-1.5">
                                <svg className="mr-2.5 h-5 w-5 flex-none stroke-slate-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 109.43" style={{ enableBackground: 'new 0 0 122.88 109.43', width: '1em', height: '1em', fill: 'grey' }}>
                                    <g>
                            ...
                            <div className="flex items-center rounded-md p-1.5">
                                <svg className="mr-2.5 h-5 w-5 flex-none stroke-slate-400" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="m3.51211712 15h4.65978517c-.11241032-.9476494-.17190229-1.9555446-.17190229-3s.05949197-2.05235058.17190229-3h-4.65978517c-.33165446.93833678-.51211712 1.9480937-.51211712 3s.18046266 2.0616632.51211712 3zm.42340253 1c1.19038468 2.3953444 3.41655713 4.1851177 6.09248965 4.783292-.77911479-1.0605169-1.37584794-2.7461558-1.71425863-4.783292zm16.55236325-1c.3316544-.9383368.5121171-1.9480937.5121171-3s-.1804627-2.06166322-.5121171-3h-4.6597852c.1124103.94764942.1719023 1.9555446.1719023 3s-.059492 2.0523506-.1719023 3zm-.4234025 1h-4.3782311c-.3384107 2.0371362-.9351438 3.7227751-1.7142586 4.783292 2.6759325-.5981743 4.902105-2.3879476 6.0924897-4.783292zm-10.88007771-1h5.63119461c.1184204-.9376118.1844027-1.9471744.1844027-3s-.0659823-2.06238817-.1844027-3h-5.63119461c-.1184204.93761183-.18440269 1.9471744-.18440269 3s.06598229 2.0623882.18440269 3zm.15057961 1c.52218852 2.9678295 1.5830906 5 2.6650177 5s2.1428292-2.0321705 2.6650177-5zm-5.39946265-8h4.37823102c.33841069-2.03713617.93514384-3.72277514 1.71425863-4.78329196-2.67593252.5981743-4.90210497 2.38794752-6.09248965 4.78329196zm16.12896075 0c-1.1903847-2.39534444-3.4165572-4.18511766-6.0924897-4.78329196.7791148 1.06051682 1.3758479 2.74615579 1.7142586 4.78329196zm-10.7294981 0h5.3300354c-.5221885-2.96782952-1.5830906-5-2.6650177-5s-2.14282918 2.03217048-2.6650177 5zm2.6650177 14c-5.5228475 0-10-4.4771525-10-10s4.4771525-10 10-10 10 4.4771525 10 10-4.4771525 10-10 10z" /></svg>
                                Web stack
                            </div>
                            <div className="flex items-center rounded-md p-1.5">
                                <svg className="mr-2.5 h-5 w-5 flex-none stroke-slate-400" xmlns="http://www.w3.org/2000/svg" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 410 512.32"><path fill="#17191E" fillRule="nonzero" d="M0 335.49s69.19-33.61 138.56-33.61l52.31-161.48c1.96-7.81 7.68-13.12 14.13-13.12 6.46 0 12.17 5.31 14.13 13.12l52.31 161.48c82.17 0 138.56 33.61 138.56 33.61S292.49 16.16 292.26 15.52C288.88 6.08 283.19 0 275.51 0H134.5c-7.68 0-13.14 6.08-16.74 15.52C117.5 16.15 0 335.49 0 335.49zm127.25 94.89c-25.3-22.82-32.69-70.78-22.15-105.52 18.28 21.9 43.6 28.84 69.84 32.76 40.49 6.04 80.27 3.78 117.89-14.48 4.3-2.09 8.28-4.87 12.98-7.69 3.53 10.1 4.45 20.31 3.22 30.69-3 25.29-15.76 44.83-36.04 59.64-8.11 5.92-16.69 11.21-25.07 16.8-25.74 17.16-32.7 37.29-23.03 66.57.23.71.43 1.43.95 3.17-13.14-5.81-22.74-14.26-30.05-25.37-7.72-11.72-11.4-24.69-11.59-38.73-.1-6.83-.1-13.72-1.03-20.45-2.27-16.42-10.08-23.77-24.79-24.19-15.1-.43-27.05 8.78-30.21 23.28-.25 1.12-.6 2.21-.95 3.51l.03.01z" /></svg>
                                Astro
                            </div>
                            <div className="flex items-center rounded-md p-1.5">
                                <svg className="mr-2.5 h-5 w-5 flex-none stroke-slate-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 598.88 1333.33" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd"><g fillRule="nonzero"><path d="M295.27 3.65l35.58 66.83c8 12.33 16.67 23.25 26.87 33.42 29.79 29.79 58.08 60.99 83.5 94.41 60.28 79.16 100.95 167.07 129.98 262.14 17.42 58.08 26.87 117.66 27.58 177.9 2.91 180.11-58.83 334.76-183.31 463.28-20.33 20.33-42.08 39.16-65.41 55.91-12.33 0-18.17-9.46-23.25-18.16-9.45-15.96-15.25-34.17-18.16-52.29-4.38-21.8-7.25-43.58-5.83-66.08v-10.16c-1-2.17-11.87-1002.07-7.54-1007.19v.01z" fill="#599636" /><path d="M295.27 1.43c-1.46-2.91-2.91-.71-4.38.71.71 14.58-4.38 27.58-12.33 40-8.75 12.33-20.33 21.8-31.96 31.96-64.57 55.91-115.4 123.45-156.11 198.98C36.33 374.74 8.41 483.68.5 598.38c-3.62 41.37 13.09 187.36 26.13 229.48 35.58 111.82 99.49 205.52 182.27 286.84 20.33 19.58 42.08 37.74 64.58 55.2 6.54 0 7.25-5.83 8.74-10.17 2.85-9.28 5.06-18.76 6.54-28.34l14.58-108.9L295.26 1.43z" fill="#6cac48" /><path d="M330.85 1201.77c1.46-16.67 9.46-30.5 18.17-44.29-8.75-3.62-15.25-10.83-20.33-18.87-4.38-7.25-8-15.96-10.83-23.96-10.17-30.5-12.33-62.5-15.25-93.66v-18.87c-3.62 2.91-4.38 27.58-4.38 31.25-2.03 32.85-6.54 65.8-13.08 98.05-2.17 13.08-3.62 26.12-11.67 37.74 0 1.46 0 2.91.71 5.09 13.08 38.5 16.67 77.7 18.87 117.66v14.58c0 17.41-.71 13.74 13.75 19.58 5.83 2.17 12.33 2.91 18.16 7.25 4.38 0 5.09-3.62 5.09-6.54l-2.17-23.96v-66.83c-.71-11.67 1.46-23.25 2.91-34.16l.05-.06z" fill="#c2bfbf" /></g></svg>
                                Mongo DB
                            </div>
                        </div>
                    </div>
                ...
                <div className="relative p-4">
                    <div className="-mr-[4.625rem] w-[30.25rem] rounded-md bg-white p-4 text-[0.8125rem] leading-6 text-slate-900 shadow-xl shadow-black/5 ring-1 ring-slate-700/10">
                        <div className="font-semibold leading-5">Education</div>
                        ...
                        <div className="mt-4 flex items-center border-t border-slate-400/20 py-3">
                            <span className="w-2/5 flex-none">Schooling</span>
                            <span className="">Abhiav Bharti High School</span>
                        ...
                        <div className="flex items-center border-t border-slate-400/20 py-3">
                            <span className="w-2/5 flex-none">B.Tech</span>
                            <span className="">Meghnad
                                Saha Institue of Technology,Kolkata</span>

                        </div>
                        <div className="flex items-center border-t border-slate-400/20 py-3">
                            <span className="w-2/5 flex-none">Average CGPA</span>
                            <span className="">
                                9.0
                            </span>
                        </div>
                        <div className="flex items-center border-t border-slate-400/20 pt-3">
                            <span className="w-2/5 flex-none" >Graduation Year</span>
                            <span className="">
                                2024
                            </span>
                        </div>
