        ...
        >
            <div className="relative flex items-center py-[2.125rem]">
                <a className="flex-none text-slate-900" href="/">
                    <span className="sr-only">Rohit</span>
                ...
                <a
                    ...
                    href="https://my-portfolio-ionicthor.vercel.app/"
                    target="_blank"
                >
                ...
                <div className="ml-auto hidden lg:flex lg:items-center">
                    <a className=" transition duration-300 ease-in-out hover:text-blue-500" href="#about">
                        About
                    </a>
                    <a className="ml-8 transition duration-300 ease-in-out hover:text-blue-500" href="#skills">
                        Skills
                    </a>
                    <a className="ml-8  transition duration-300 ease-in-out hover:text-blue-500" href="#projects">
                        Projects
                    </a>
                </div>
                <button
                ...
                <div className="  hidden lg:ml-8 lg:flex lg:items-center lg:border-l lg:border-slate-900/15 lg:pl-8">
                    <a className=" transition duration-300 ease-in-out hover:text-blue-500" href="#contact">Contact </a>
                    <button
                        className="animate-pulse inline-flex justify-center rounded-lg text-sm font-semibold py-2.5 px-4 bg-slate-900 text-white hover:bg-slate-700 -my-2.5 ml-8"
                        // onClick="window.open('https://my-portfolio-ionicthor.vercel.app/assets/Resume.pdf')"
                    >
                        <span>
                            resume <span aria-hidden="true">
